...
function getComponentTokens(theme: keyof typeof semantic) {
  ...
  return {
    ...
    avatar: {
      ...
      border: s.border.subtle,
      fg: s.text.primary,
      iconFg: s.text.secondary,
      dot: color.success[500],
      dotBorder: s.surface.base,
      stackBorder: s.border.inverse,
      counterBg: s.intent.primary.base,
      counterFg: s.intent.primary.onBase,
