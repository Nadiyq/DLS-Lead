...
const LEGACY_TO_4LAYER = {
  ...
  'primary/default':       'intent/primary/base',
  'primary/light':         'intent/primary/subtle',
  'primary/dark':          'intent/primary/strong',
  'primary/border':        'intent/primary/border',
  'intent/primary/base':   'intent/primary/base',
  'intent/primary/subtle': 'intent/primary/subtle',
  'intent/primary/strong': 'intent/primary/strong',

  'success/default':       'intent/success/base',
  'success/light':         'intent/success/subtle',
  'success/dark':          'intent/success/strong',
  'success/border':        'intent/success/border',
  'intent/success/base':   'intent/success/base',
  'intent/success/subtle': 'intent/success/subtle',
  'intent/success/strong': 'intent/success/strong',

  'warning/default':       'intent/warning/base',
  'warning/light':         'intent/warning/subtle',
  'warning/dark':          'intent/warning/strong',
  'warning/border':        'intent/warning/border',
  'intent/warning/base':   'intent/warning/base',
  'intent/warning/subtle': 'intent/warning/subtle',
  'intent/warning/strong': 'intent/warning/strong',

  'danger/default':       'intent/danger/base',
  'danger/light':         'intent/danger/subtle',
  'danger/dark':          'intent/danger/strong',
  'danger/border':        'intent/danger/border',
  'intent/danger/base':   'intent/danger/base',
  'intent/danger/subtle': 'intent/danger/subtle',
  'intent/danger/strong': 'intent/danger/strong',

  'info/default':       'intent/info/base',
  'info/light':         'intent/info/subtle',
  'info/dark':          'intent/info/strong',
  'info/border':        'intent/info/border',
  'intent/info/base':   'intent/info/base',
  'intent/info/subtle': 'intent/info/subtle',
  'intent/info/strong': 'intent/info/strong',

  'intent/neutral/base':   'intent/neutral/base',
  'intent/neutral/subtle': 'intent/neutral/subtle',
  'intent/neutral/strong': 'intent/neutral/strong',
};
